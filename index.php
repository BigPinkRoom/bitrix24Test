    ...
    <div class="first-info__inner">
      ...
      <div class="first-info__item">
        <div class="first-info__image">
          <img class="first-info__icon" src="<?=SITE_TEMPLATE_PATH?>/images/first-info/first-info_1.png" alt="">
        </div>
        <div class="first-info__text-content">
          <h2 class="first-info__title">Content Concept & Strategy</h2>
          <div class="first-info__text">Aenean pharetra magna ac placerat magna vestibulum lectus mauris ultrices eros.
            Eget aliquet nibh dignissim odio velit mauris.</div>
        </div>
      </div>

      <div class="first-info__item">
        <div class="first-info__image">
          <img class="first-info__icon" src="<?=SITE_TEMPLATE_PATH?>/images/first-info/first-info_2.png" alt="">
        </div>
        <div class="first-info__text-content">
          <h2 class="first-info__title">Design & Concepts</h2>
          <div class="first-info__text">In egestas erat imperdiet sed euismod. A diam maecenas sed enim ut sem. Faucibus
            in ornare quam viverra.</div>
        </div>
      </div>

      <div class="first-info__item">
        <div class="first-info__image">
          <img class="first-info__icon" src="<?=SITE_TEMPLATE_PATH?>/images/first-info/first-info_3.png" alt="">
        </div>
        <div class="first-info__text-content">
          <h2 class="first-info__title">SEO & Marketing Solutions</h2>
          <div class="first-info__text">In egestas erat imperdiet sed euismod. A diam maecenas sed enim ut sem. Faucibus
            in ornare quam viverra.</div>
        </div>
      </div>
